...
class courseCreate(TestCase):
    ...
    def test_course_ok(self):
       ...
       data = {'name': 'Django para Zumbis', 'slug': 'DZ', 'description': 'Este curso e para zumbis', 'program': 'Esta e a programacao', 'qtd_available': '30', 'qtd_students': '20', 'begin_matric': '', 'end_matric': '', 'begin_course': '', 'end_course': '', 'image': '', 'is_approved': '', 'teacher': 'Gileno', 'category': 'Python', 'modules': 'Desenvolvendo uma aplicacao Web', 'keywords': ''}
